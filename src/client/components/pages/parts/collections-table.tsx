...
import { _Collection, _User } from '../../../../types';
...
interface Props {
	...
	ownerId?: number;
	results: Array<_Collection>;
	showIfOwnerOrCollaborator?: boolean;
...
function CollectionsTable({showLastModified, showOwner, showIfOwnerOrCollaborator, showPrivacy, results, tableHeading, user, ownerId, entityTypes, type, onTypeChange}: Props): React.JSX.Element {
	const entityTypeSelect = (
		<DropdownButton
			className="margin-bottom-d5"
			id="entity-type-select"
			title={_.startCase(type) || 'Entity Type'}
			variant="primary"
	...
	function handleEntitySelect(newType) {
